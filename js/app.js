    ...
    (() => {
        ...
        function tabs() {
            ...
            if (tabs.length > 0) {
                ...
                if (tabsMedia.length > 0) initMediaTabs(tabsMedia);
            }
            function initMediaTabs(tabsMedia) {
                ...
                mediaQueries.forEach((breakpoint => {
                    ...
                    const tabsMediaArray = breakpointsArray.filter((function(item) {
                        if (item.value === mediaBreakpoint) return true;
                    }));
                    matchMedia.addEventListener("change", (function() {
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offset = 0) => {
            ...
            if (targetBlockElement) {
                ...
                if ("undefined" !== typeof SmoothScroll) (new SmoothScroll).animateScroll(targetBlockElement, "", options); else window.scrollTo({
